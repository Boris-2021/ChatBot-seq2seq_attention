...
class Corpus:
    ...
    def __init__(self, filePath, maxSentenceWordsNum=-1, id2word=None, word2id=None, wordNum=None, tfidf=False, QIDF=None, AIDF=None, testSize=0.2, isCharVec=False):
        ...
        self._word_id_map(data)  # 对data做一个映射，每个词对应标号。
        try:
        ...
        self.QChatDataId, self.AChatDataId = [qa[0] for qa in chatDataId], [qa[1] for qa in chatDataId]  # question和answer的id列表。
